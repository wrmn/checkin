...
const Home = () => {
    return (
        <div className="flex flex-col items-center justify-center h-24 min-h-screen bg-gradient-to-t from-zinc-300 to-gray-300 ">
            <Head>
            ...
            <main className="flex flex-col flex-1 w-full px-3 text-center">
                ...
                <div className="flex flex-row justify-center w-full pt-5 text-center h-3/4">
                    ...
                    <div className="flex-col inline-block w-5/12 align-middle rounded-lg bg-gradient-to-l from-zinc-200">
                        <div className="my-10">
                            <h1 className="text-2xl font-bold -pt-4">
                ...
                <div className="flex flex-row justify-center w-full pt-5 -mt-20 text-center">
                    <div className="flex-col inline-block w-10/12 h-40 align-middle bg-gradient-to-r from-zinc-400">
                        something
                    </div>
                </div>
            </main>
